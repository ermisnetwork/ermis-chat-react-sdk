...
export default function Page404() {
  const { colorPrimary, colorPrimaryActive, colorPrimaryTextActive, colorPrimaryHover } =
    useThemeToken();
  ...
  return (
    <>
      <Helmet>
        <title>{t('common.page404Title')}</title>
      </Helmet>
      ...
      <div className="m-auto max-w-[400px]">
        <MotionContainer className="flex flex-col items-center justify-center px-2">
          ...
          <Button size="large" type="primary" onClick={onGoToHome}>
            {t('common.goToHome')}
          </Button>
        </MotionContainer>
      </div>
