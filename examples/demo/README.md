...
<h1> Ermis dashboard </h1>
<p style="font-size: 14px">
  Ermis dashboard is a modern admin dashboard template built with React 18, Vite, Ant Design, and TypeScript. It is designed to help developers quickly create powerful admin management systems.
</p>
</div>

## Preview
+ https://dashboard.ermis.network/
...
```bash
git clone https://github.com/ermisnetwork/ermis-dashboard.git
```
