...
const UserResult = ({ user }: { user: UserResponse<ErmisChatGenerics> }) => (
...
const CreateChannel = (props: Props) => {
  ...
  const { client, setActiveChannel } = useChatContext<ErmisChatGenerics>();
  ...
  const [users, setUsers] = useState<UserResponse<ErmisChatGenerics>[]>([]);
  ...
  const addUser = (addedUser: UserResponse<ErmisChatGenerics>) => {
  ...
  const removeUser = (user: UserResponse<ErmisChatGenerics>) => {
