...
export type InfiniteScrollProps = PaginatorProps & {
   ...
   * @deprecated Use hasPreviousPage prop instead. Planned for removal: https://github.com/ermisnetwork/ermis-chat-react-sdk/issues/1804
   */
  hasMore?: boolean;
  /**
   * @desc Flag signalling whether more pages with newer items can be loaded
   * @deprecated Use hasNextPage prop instead. Planned for removal: https://github.com/ermisnetwork/ermis-chat-react-sdk/issues/1804
   */
   ...
   * @deprecated Use loadPreviousPage prop instead. Planned for removal: https://github.com/ermisnetwork/ermis-chat-react-sdk/issues/1804
   */
  loadMore?: () => void;
  /**
   * @desc Function that loads next page with newer items
   * @deprecated Use loadNextPage prop instead. Planned for removal: https://github.com/ermisnetwork/ermis-chat-react-sdk/issues/1804
   */
  loadMoreNewer?: () => void;
  useCapture?: boolean;
};
